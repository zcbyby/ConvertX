...
import { HIDE_HISTORY, LANGUAGE, TIMEZONE, WEBROOT } from "../helpers/env";
import { userService } from "./user";
import { EyeIcon } from "../icons/eye";
import { DeleteIcon } from "../icons/delete";

export const history = new Elysia().use(userService).get("/history", async ({ redirect }) => {
  if (HIDE_HISTORY) {
    return redirect(`${WEBROOT}/`, 302);
  }

  let userJobs = db.query("SELECT * FROM jobs").as(Jobs).all().reverse();
